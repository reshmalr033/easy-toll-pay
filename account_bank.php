...
<?php
                            ...
                            {
                                $b=mysql_query("select max(id) from account_bank");
$id=mysql_result($b,0);
$id++;
$p=$_FILES['p1']['name'];
$ext=strchr($p,'.');
...
{
   $a=mysql_query("select max(id) from account_bank");
$id=mysql_result($a,0);
$id++;
$f=$_FILES['f1']['name'];
$ext=strchr($f,'.');
...
$msg2=  nl2br($msg1); 
         ...
         {
                                $acc=mysql_query("select * from account_bank where account_no='$n'");
	...
	else
	{
                                ...
                                $add=mysql_query("select * from account_bank where aadhar_no='$_POST[t4]'");
	...
	{
     mysql_query("insert into account_bank(name,address,contact,gender,aadhar_no,id_proof,photo,account_no,amount,status)values('$_POST[t1]','$msg2','$_POST[t3]','$_POST[r1]','$_POST[t4]','$fname','$pname','$n','0','1')");
            ...
            <div class="col-lg-12">
                ...
                <div class="col-lg-6"><h2 style="color: #00ACED;font: italic">Create Account</h2>
                    ...
                    <table  class="table  table-responsive  table-striped table-bordered ">
                        ...
                        <tr>
                            <td>Contact</td>
                            <td><input type="text"name="t3"id="t3"class="form-control"onblur="chkpass(this.value)"required="required"id="n3"></td>
                        </tr>
    ...
    <br/>
                ...
                <?php
                                        if(isset($_GET['t']))
                                        {
                                          if($_GET['t']==1)
                                          {
                                              $sel_m1=mysql_query("select * from account_bank where id=".$_GET['mid']);
        ...
        <tr>
         ...
         <tr>
             ...
             <td><b>Id Proof:</b>    <a href="img2//<?php echo $r_m1['6']?>"target="_blank"><span class="glyphicon glyphicon-fullscreen"style="color: #D00030"></span></a></td>
                                        ...
                                        $sel_mem=mysql_query("select * from account_bank");
                                        if(mysql_num_rows($sel_mem)>0)
                                        {
                                            ?>
                                        ...
                                        <?php
                                        $i=1;
                                            while($r_mem=mysql_fetch_row($sel_mem))
                                            {
                                                ?>
                                            <tr>
                                                <td><?php echo $i ?></td>
