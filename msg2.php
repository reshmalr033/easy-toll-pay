...
if(isset($_GET['mid']))
{
    $upd=mysql_query("update add_toll set st='1' where id='".$_GET['mid']."'");
    //echo mysql_error();
    if($upd>0)
    {
                      ...
                      <div class="inbox-body">
                          ...
                          <?php
                                        if(isset($_GET['t']))
                                        {
                                          if($_GET['t']==1)
                                          {
                                              $sel_m1=mysql_query("select * from add_toll where id=".$_GET['mid']);
              ...
              <div class="panel panel-default arrow left">
                <div class="panel-body">
                  ...
                  <div class="comment-post">
                    <p>
                        You have been charged <b style="color: red" ><?php echo $r_m1['3']?> Rs/-</b> in <b style="color: orange" ><?php echo $r_m1['6']?></b>
                    </p>
                    <p>
                       <?php echo $r_m1['7']?> 
                    </p>
                    ...
                    <p class="text-right"><a href="msg2.php" class="btn btn-default btn-sm"><i class="fa fa-reply"></i> Back</a>
            ...
            <?php
                    ...
                    $a=$_SESSION['username'];
                           ...
                           { 
                            ...
                            $ab=mysql_query("select * from add_toll where vehicle_id='$vs2' order by id desc");
                         $i=1;
                            ...
                            <b>
                                ...
                                <td class="view-message dont-show"><b>Your transaction for Toll Charge in <span style="color: orange;font-style: italic"><?php echo $ab1['6']?></span> is complete</b></td>
                                <td class="view-message dont-show"><b><?php echo $ab1['4']?></b></td>
                                
                                  
                                  <td class="view-message text-right"><a href="msg2.php?t=1&mid=<?php echo $ab1[0] ?>"><span class="glyphicon glyphicon-new-window"></span></a></td>
